...
def create_excel_file(results, output_file='FCSA_Benchmark_Dim100_Results.xlsx'):
...
def main():
    ...
    input_file = 'fig\dim_100\Test_100_log.txt'  # Change this to your actual file path
